...
_C.DATASET.LIMBS_NUM = 5
_C.DATASET.LIMBS_CONTEXT = [3, 3, 3, 3, 2]
_C.DATASET.LIMBS_KEYPOINTS_INDEX = [0, 2, 4, 1, 3, 5, 6, 8, 10, 7, 9, 11, 12, 13]
_C.DATASET.KEYPOINTS_RESTORE_INDEX = [0, 3, 1, 4, 2, 5, 6, 9, 7, 10, 8, 11, 12, 13]
# 关键点归一化因子
_C.DATASET.KEYPOINTS_SIGMAS = []
