...
FLIP_CONFIG = {
    ...
    # 用于训练时的transform
    'COCO_WITH_CENTER': [
            0, 2, 1, 4, 3, 6, 5, 8, 7, 10, 9, 12, 11, 14, 13, 16, 15, 17, 19, 18, 21, 20, 22
    ],
    # 用于推理时翻转关键点热图
    'COCO_WITH_ONLY_CENTER': [
    ...
    'CROWDPOSE_WITH_CENTER': [
        1, 0, 3, 2, 5, 4, 7, 6, 9, 8, 11, 10, 12, 13, 15, 14, 17, 16, 18, 19
    ],
    # 专用于热图翻转
    "CROWDPOSE_WITH_ONLY_CENTER": [1, 0, 3, 2, 5, 4, 7, 6, 9, 8, 11, 10, 12, 13, 14]
}
